...
public class Boundary {
    ...
    public void split(int level) {
        ...
        Boundary se = new Boundary(this.getXmax() / 2 + 1, this.getXmax(), this.getYmax() / 2 + 1, this.getYmax(), level);
    ...
    public String toString() {
        return "(" + this.getXmin() + "," + this.getXmax() + "," + this.getYmin() + "," + this.getYmax() + ") level: " + this.getBoundaryLevel();
    }
}